<template>
  <nav class="navbar navbar-dark navbar-expand-md bg-dark py-3">
    <div class="container"><a style='cursor: pointer;' class="navbar-brand d-flex align-items-center" @click="GoHome"><span
      ...
      <button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-5"><span class="visually-hidden">Toggle navigation</span><span
